...
const Modal: NextPage<TModal> = ({ isUser = true }) => {
	...
	return (
			<div className='fixed top-0 left-0 right-0 bottom-0 z-[100] flex items-center justify-center bg-black/50'>
				<div
					className='relative w-full max-w-[80%] overflow-hidden bg-transparent  md:max-w-sm'
				>
					<div
...
const FormSignIn: NextPage<FormProps> = ({ isSignUp, setIsSignUp }) => {
	...
	const ErrorMsgSignIn = ({
		...
		const Component =
			touch && error ? (
				<div className={classErrorMsg.text}>
		...
		<div className='w-full min-w-full rounded-lg bg-white p-6 dark:bg-[#221F2C]'>
						...
						<input
							...
							className={
								clsx (
									...
									{
										'outline-red-500 border-red-500 text-red-500 dark:text-red-500' : formikSignIn.touched.LoginEmail && formikSignIn.errors.LoginEmail,
										'border-neutral-400 outline-neutral-400 text-black dark:text-white' : !formikSignIn.touched.LoginEmail || !formikSignIn.errors.LoginEmail,
									}
								)
							}
						/>
						<label
							...
							className={
								clsx (
									...
									{
										'text-red-500 dark:text-red-500' : formikSignIn.touched.LoginEmail && formikSignIn.errors.LoginEmail,
										'text-black dark:text-white' : !formikSignIn.touched.LoginEmail || !formikSignIn.errors.LoginEmail,
									}
								)
							}
						>
						...
						<input
							...
							className={
								clsx (
									'peer w-full rounded-[4px] border-[1px] py-4 px-4 text-xs font-medium dark:bg-[#393547] dark:caret-white caret-black',
									{
										'outline-red-500 border-red-500 text-red-500 dark:text-red-500' : formikSignIn.touched.LoginPassword && formikSignIn.errors.LoginPassword,
										'border-neutral-400 outline-neutral-400 text-black dark:text-white' : !formikSignIn.touched.LoginPassword || !formikSignIn.errors.LoginPassword,
									}
								)
							}
						/>
						<label
							...
							className={
								clsx (
									'absolute left-3 top-0 -translate-y-1/2 bg-white dark:bg-[#393547] dark:peer-focus:bg-[#393547] px-2 text-xs font-medium transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:bg-transparent peer-focus:top-0 peer-focus:bg-white',
									{
										'text-red-500 dark:text-red-500' : formikSignIn.touched.LoginPassword && formikSignIn.errors.LoginPassword,
										'text-black dark:text-white' : !formikSignIn.touched.LoginPassword || !formikSignIn.errors.LoginPassword,
									}
								)
							}
						>
				...
				<button
					...
					className={
						clsx (
							...
							{
								'bg-gray-500 hover:bg-gray-400 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40' : formikSignIn.isSubmitting,
								'bg-blue-600 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40' : !formikSignIn.isSubmitting,
							}
						)
					}
				>
			...
			<div className='mx-auto mt-5 flex w-full flex-col items-center justify-center gap-5'>
				<button
				 ...
				 className='block transform rounded-md bg-blue-600 px-4 py-2 text-white transition-colors duration-300 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 w-full'>
							Sign In with Google
				</button>
	...
	const formikSignUp = useFormik({
		...
		validationSchema: Yup.object({
			userLogin: Yup.string()
				...
				.required('This field is required !')
				.test('userLogin', 'Please, use underscores or dashes instead of spaces !', (userLogin) => !userLogin.includes(' ')),
			...
			userPasswordRepeat: Yup.string()
				...
				.when('userPassword', {
					...
					then: () => Yup.string().oneOf([Yup.ref('passwordNew')], 'Both passwords must be the same !')
				}),
							...
							<input
								...
								className={
									clsx (
										'peer w-full rounded-[4px] border-[1px] py-4 px-4 text-xs font-medium dark:bg-[#393547] dark:caret-white caret-black',
										{
											'outline-red-500 border-red-500 text-red-500 dark:text-red-500' : formikSignUp.touched.userLogin && formikSignUp.errors.userLogin,
											'border-neutral-400 outline-neutral-400 text-black dark:text-white' : !formikSignUp.touched.userLogin || !formikSignUp.errors.userLogin,
										}
									)
								}
							/>
							<label
								...
								className={
									clsx (
										'absolute left-3 top-0 -translate-y-1/2 bg-white dark:bg-[#393547] dark:peer-focus:bg-[#393547] px-2 text-xs font-medium transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:bg-transparent peer-focus:top-0 peer-focus:bg-white',
										{
											'text-red-500 dark:text-red-500' : formikSignUp.touched.userLogin && formikSignUp.errors.userLogin,
											'text-black dark:text-white' : !formikSignUp.touched.userLogin || !formikSignUp.errors.userLogin,
										}
									)
								}
							>
			...
			<input
				...
				className={
					clsx (
						'peer w-full rounded-[4px] border-[1px] py-4 px-4 text-xs font-medium dark:bg-[#393547] dark:caret-white caret-black',
						{
							'outline-red-500 border-red-500 text-red-500 dark:text-red-500' : formikSignUp.errors.userEmail && formikSignUp.touched.userEmail,
							'border-neutral-400 outline-neutral-400 text-black dark:text-white' : !formikSignUp.errors.userEmail || !formikSignUp.touched.userEmail,
						}
					)
				}
			/>
			<label
				...
				className={
					clsx (
						'absolute left-3 top-0 -translate-y-1/2 bg-white dark:bg-[#393547] dark:peer-focus:bg-[#393547] px-2 text-xs font-medium transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:bg-transparent peer-focus:top-0 peer-focus:bg-white',
						{
							'text-red-500 dark:text-red-500' : formikSignUp.errors.userEmail && formikSignUp.touched.userEmail,
							'text-black dark:text-white' : !formikSignUp.errors.userEmail || !formikSignUp.touched.userEmail,
						}
					)
				}
			>
		...
		<ErrorMsgSignUp
			...
			/>
					...
					<div className='w-full'>
							...
							<input
								...
								className={
									clsx (
										'peer w-full rounded-[4px] border-[1px] py-4 px-4 text-xs font-medium dark:bg-[#393547] dark:caret-white caret-black',
										{
											'outline-red-500 border-red-500 text-red-500 dark:text-red-500' : formikSignUp.touched.userPassword && formikSignUp.errors.userPassword,
											'border-neutral-400 outline-neutral-400 text-black dark:text-white' : !formikSignUp.touched.userPassword || !formikSignUp.errors.userPassword,
										}
									)
								}
							/>
							<label
								...
								className={
									clsx (
										'absolute left-3 top-0 -translate-y-1/2 bg-white dark:bg-[#393547] dark:peer-focus:bg-[#393547] px-2 text-xs font-medium transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:bg-transparent peer-focus:top-0 peer-focus:bg-white',
										{
											'text-red-500 dark:text-red-500' : formikSignUp.touched.userPassword && formikSignUp.errors.userPassword,
											'text-black dark:text-white' : !formikSignUp.touched.userPassword || !formikSignUp.errors.userPassword,
										}
									)
								}
							>
						...
						<div
							className='mt-2 hidden cursor-pointer text-black dark:text-white'
							...
							<input
								...
								className={
									clsx (
										'peer w-full rounded-[4px] border-[1px] py-4 px-4 text-xs font-medium dark:bg-[#393547] dark:caret-white caret-black',
										{
											'outline-red-500 border-red-500 text-red-500 dark:text-red-500' : formikSignUp.touched.userPasswordRepeat && formikSignUp.errors.userPasswordRepeat,
											'border-neutral-400 outline-neutral-400 text-black dark:text-white' : !formikSignUp.touched.userPasswordRepeat || !formikSignUp.errors.userPasswordRepeat,
										}
									)
								}
							/>
							<label
								...
								className={
									clsx (
										'absolute left-3 top-0 -translate-y-1/2 bg-white dark:bg-[#393547] dark:peer-focus:bg-[#393547] px-2 text-xs font-medium transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:bg-transparent peer-focus:top-0 peer-focus:bg-white',
										{
											'text-red-500 dark:text-red-500' : formikSignUp.touched.userPasswordRepeat && formikSignUp.errors.userPasswordRepeat,
											'text-black dark:text-white' : !formikSignUp.touched.userPasswordRepeat || !formikSignUp.errors.userPasswordRepeat,
										}
									)
							}
							>
							...
							<label
								...
								className={
									clsx (
										...
										{
											'text-red-500 dark:text-red-500' : formikSignUp.touched.userAgree && formikSignUp.errors.userAgree,
											'text-black dark:text-white' : !formikSignUp.touched.userAgree || !formikSignUp.errors.userAgree,
										}
									)
								}
							>
								<span
									className={
										clsx (
											'relative border-[1px] rounded-sm w-3 h-3 transition-all',
											{
												'bg-transparent text-red-500 border-red-500' : formikSignUp.touched.userAgree && formikSignUp.errors.userAgree,
												'bg-transparent text-sky-400 border-sky-400' : !formikSignUp.touched.userAgree || !formikSignUp.errors.userAgree,
											}
										)
									}
								>
					...
					<button
						...
						className={
							clsx (
								...
								{
									'bg-gray-500 hover:bg-gray-400 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40' : formikSignUp.isSubmitting,
									'bg-blue-600 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40' : !formikSignUp.isSubmitting,
								}
							)
						}
					>
